[Files]
Source: Package files\STSADM.EXE; DestDir: {app}; Flags: overwritereadonly ignoreversion
Source: Package files\JUMP Icon.ico; DestDir: {app}; Flags: overwritereadonly ignoreversion
Source: Package files\ISSkin.dll; DestDir: {app}; Flags: overwritereadonly ignoreversion
Source: Package files\Office2007Gray.bmp; DestDir: {app}; Flags: overwritereadonly ignoreversion
Source: Package files\Office2007.cjstyles; DestDir: {app}; Flags: overwritereadonly ignoreversion
Source: ..\Installer\Installer\bin\Debug\Installer.exe; DestDir: {app}; Flags: overwritereadonly ignoreversion
Source: ..\..\ITXProjectsLibrary\ITXProjectsLibrary\bin\Debug\ITXProjectsLibrary.dll; DestDir: {app}; StrongAssemblyName: ITX Library; Flags: noregerror gacinstall uninsneveruninstall overwritereadonly ignoreversion
Source: ..\ITXPGReportUtilities\bin\Debug\ITXPGReportUtilities.dll; DestDir: {app}; StrongAssemblyName: ITX Library; Flags: noregerror gacinstall uninsneveruninstall overwritereadonly ignoreversion
Source: GAC\Newtonsoft.Json.Net35.dll; DestDir: {app}; StrongAssemblyName: ITX Library; Flags: noregerror gacinstall uninsneveruninstall overwritereadonly ignoreversion
Source: GAC\Infralution.Licensing.CF.dll; DestDir: {app}; StrongAssemblyName: ITX Library; Flags: noregerror gacinstall uninsneveruninstall overwritereadonly ignoreversion
Source: GAC\Infralution.Licensing.dll; DestDir: {app}; StrongAssemblyName: ITX Library; Flags: noregerror gacinstall uninsneveruninstall overwritereadonly ignoreversion
Source: GAC\Telerik.WinControls.dll; DestDir: {app}; StrongAssemblyName: ITX Library; Flags: noregerror gacinstall uninsneveruninstall overwritereadonly ignoreversion
Source: GAC\Telerik.WinControls.Themes.Breeze.dll; DestDir: {app}; StrongAssemblyName: ITX Library; Flags: noregerror gacinstall uninsneveruninstall overwritereadonly ignoreversion
Source: GAC\Telerik.WinControls.Themes.Office2007Black.dll; DestDir: {app}; StrongAssemblyName: ITX Library; Flags: noregerror gacinstall uninsneveruninstall overwritereadonly ignoreversion
...
[Setup]
OutputDir=C:\Documents and Settings\Administrator\Desktop\ITXProjectGovernanceReport
VersionInfoProductName=ITXProjectGovernanceReport
VersionInfoProductVersion=2.0
AppName=ITXProjectGovernanceReport
AppVerName=2.0
UserInfoPage=false
DisableProgramGroupPage=true
ShowLanguageDialog=no
CreateAppDir=true
DefaultDirName={pf}\ITXProjectGovernanceReport
UsePreviousUserInfo=false
VersionInfoVersion=2.0
VersionInfoCompany=ITX Solutions India Pvt Ltd
RestartIfNeededByRun=false
WizardImageFile=Package files\Office2007Gray.bmp
DefaultGroupName=ITXProjectGovernanceReport
WizardSmallImageFile=C:\Documents and Settings\Administrator\Desktop\Template Installer Tool Kit\ISTOOL Installer\Package files\Jump Logo.bmp
WizardImageStretch=false
AppendDefaultDirName=false
OutputBaseFilename=ITXProjectGovernanceReport
SetupIconFile=C:\Documents and Settings\Administrator\Desktop\Template Installer Tool Kit\ISTOOL Installer\Package files\ITXIcon.ico
DisableDirPage=true
DisableFinishedPage=true
DisableReadyPage=true
[Run]
Filename: {app}\Installer.exe; Parameters: installer; WorkingDir: {app}
...
Name: {app}\Layouts
Name: {app}\Bin
Name: {app}\Layouts\ITXProjectGovernanceReport
Name: {app}\Features; Flags: uninsalwaysuninstall
Name: {app}\Features\ITXProjectGovernanceReport
