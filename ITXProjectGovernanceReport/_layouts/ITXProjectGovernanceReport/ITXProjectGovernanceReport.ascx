<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ITXProjectGovernanceReport.ascx.cs"
    Inherits="ITXProjectGovernanceReport._layouts.ITXProjectGovernanceReport.ITXProjectGovernanceReport" %>
<link href="/_layouts/ITXProjectGovernanceReport/jquery-ui-1.8.4.css" rel="stylesheet"
    type="text/css" />
...
<script type="text/javascript" src="/_layouts/ITXProjectGovernanceReport/jquery-1.4.2.js"></script>

<script type="text/javascript" src="/_layouts/ITXProjectGovernanceReport/date.js"></script>

<script type="text/javascript" src="/_layouts/ITXProjectGovernanceReport/jquery-ui-1.8.4.js"></script>
